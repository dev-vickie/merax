...
const testimonials = [
  {
    ...
    feedback:
      "Merax Construction exceeded our expectations. Their attention to detail and timely delivery is unmatched!",
    image: "/test.jpeg",
  },
  {
    name: "client name",
    ...
    feedback:
      "Collaborating with them was seamless. They brought our designs to life with perfection.",
    image: "/test.jpeg",
  },
  {
    name: "client name",
    ...
    feedback:
      "Their professionalism and commitment to quality truly set them apart.",
    image: "/test.jpeg",
  },
];
    ...
    <section className="bg-white py-16 px-6">
      <div className="max-w-5xl mx-auto text-center">
        ...
        <div className="mt-8 flex justify-center gap-4">
          <button
            onClick={prev}
            className="px-4 py-2 bg-yellow-400 hover:bg-yellow-300 text-black rounded-lg"
          >
            Prev
          </button>
          <button
