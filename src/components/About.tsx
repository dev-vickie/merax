      ...
      <div className="flex.flex-col md:flex-row max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-12 items-start">
        ...
        <div>
          ...
          <p className="text-gray-500 text-sm mb-6 leading-relaxed">
            ...
            plumbing, and waterproofing services. With a commitment to quality
            and customer satisfaction, we offer comprehensive solutions tailored
